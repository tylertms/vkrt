...
VKRT_Result createRayTracingPipeline(VKRT* vkrt) {
    ...
    shadowClosestHitStageInfo.sType = VK_STRUCTURE_TYPE_PIPELINE_SHADER_STAGE_CREATE_INFO;
    shadowClosestHitStageInfo.stage = VK_SHADER_STAGE_CLOSEST_HIT_BIT_KHR;
